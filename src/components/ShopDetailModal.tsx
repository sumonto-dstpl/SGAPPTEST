...
<PaymentRows payments={shop.payments} />
      ...
      <button
        ...
        className="mt-5 w-full flex items-center justify-center gap-2 py-2.5 border border-gray-200 rounded-xl text-sm font-semibold text-gray-700 hover:bg-blue-700 transition-colors"
      >
